...
public abstract interface FavoritesDao {
    ...
    @androidx.room.Query(value = "SELECT EXISTS(SELECT 1 FROM favorites WHERE id = :id)")
    @org.jetbrains.annotations.Nullable
