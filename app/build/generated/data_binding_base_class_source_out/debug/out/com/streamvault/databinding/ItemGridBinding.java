...
public final class ItemGridBinding implements ViewBinding {
  ...
  private ItemGridBinding(@NonNull LinearLayout rootView, @NonNull ImageView imgCover,
  ...
  public static ItemGridBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemGridBinding((LinearLayout) rootView, imgCover, tvName, tvRating);
    }
