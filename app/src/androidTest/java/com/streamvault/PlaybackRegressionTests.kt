...
class PlaybackRegressionTests {
    ...
    @Test fun loudnessColumnSurvivesUpgradeFromVersionTwo() = runBlocking<Unit> {
        ...
        raw.execSQL("ALTER TABLE tracks DROP COLUMN peakDb")
        raw.execSQL("ALTER TABLE tracks DROP COLUMN trackNumber")
        raw.execSQL("ALTER TABLE tracks DROP COLUMN discNumber")
