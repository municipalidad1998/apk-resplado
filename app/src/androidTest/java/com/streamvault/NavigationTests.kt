...
class NavigationTests {
    ...
    @Test fun allFiveDestinationsAndPlaylistCreationAreReachable() {
        ...
        compose.onNodeWithText("Explorar", useUnmergedTree = true).performClick()
        compose.onNodeWithText("MÚSICA ONLINE").assertIsDisplayed()
        compose.onNodeWithText("Canción, artista, álbum, concierto…").performTextInput("no-existe-12345")
        compose.onNodeWithText("Biblioteca", useUnmergedTree = true).performClick()
