...
class LuminaApp : Application() {
    ...
    val database by lazy { Room.databaseBuilder(this, LibraryDatabase::class.java, "lumina-library.db").addMigrations(LibraryDatabase.MIGRATION_1_2, LibraryDatabase.MIGRATION_2_3, LibraryDatabase.MIGRATION_3_4).build() }
